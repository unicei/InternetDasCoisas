...
function sendToAPI() {
  ...
  //http.open("GET", " https://api.thingspeak.com/update?api_key=QTBKJD0VDKFQQRJS&field1="+luxGlobal);
  http.open("POST", "https://paulovitormedeiros.000webhostapp.com/api.php/lux_sensor");
